...
(() => {
var exports = {};
exports.id = "app/api/generate-section/route";
exports.ids = ["app/api/generate-section/route"];
exports.modules = {

/***/ "(rsc)/./app/api/generate-section/route.ts":
/*!*******************************************!*\
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var _google_genai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @google/genai */ \"(rsc)/./node_modules/@google/genai/dist/node/index.mjs\");\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n\n\nasync function POST(request) {\n    const apiKey = process.env.GEMINI_API_KEY || process.env.API_KEY || \"\";\n    if (!apiKey) {\n        return next_server__WEBPACK_IMPORTED_MODULE_1__.NextResponse.json({\n            error: \"Gemini API key is missing. Set GEMINI_API_KEY in .env.local.\"\n        }, {\n            status: 500\n        });\n    }\n    const { sectionTitle, systemPrompt, userNotes, knowledgeContext } = await request.json();\n    const ai = new _google_genai__WEBPACK_IMPORTED_MODULE_0__.GoogleGenAI({\n        apiKey\n    });\n    let contextString = \"\";\n    const sourceIds = [];\n    if (knowledgeContext.length > 0) {\n        contextString += \"\\n\\nRELEVANT KNOWLEDGE BASE CONTEXT:\\n\";\n        for (const chunk of knowledgeContext){\n            contextString += `--- Source: ${chunk.title} ---\\n${chunk.content}\\n`;\n            sourceIds.push(chunk.id);\n        }\n        contextString += \"\\nUse the above context to ensure accuracy, but adapt it to the document structure.\\n\";\n    }\n    const prompt = `\nTASK: Write a document section titled \"${sectionTitle}\".\n\nGUIDELINES:\n${systemPrompt}\n\nUSER SPECIFIC NOTES:\n${userNotes || \"No specific notes provided.\"}\n\n${contextString}\n\nOutput only the content of the section. Do not include the title or markdown code blocks unless necessary for the content itself.\n`;\n    try {\n        const response = await ai.models.generateContent({\n            model: \"gemini-2.5-flash\",\n            contents: prompt\n        });\n        return next_server__WEBPACK_IMPORTED_MODULE_1__.NextResponse.json({\n            text: response.text || \"No content generated.\",\n            sources: sourceIds\n        });\n    } catch (error) {\n        console.error(\"Gemini generation error:\", error);\n        return next_server__WEBPACK_IMPORTED_MODULE_1__.NextResponse.json({\n            error: \"Failed to generate section content.\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/generate-section/route.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fgenerate-section%2Froute&page=%2Fapi%2Fgenerate-section%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fgenerate-section%2Froute.ts&appDir=C%3A%5CUsers%5Csyntax%5CDocuments%5Cprojects%5Cremix_-digicred-v9%5Capp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=C%3A%5CUsers%5Csyntax%5CDocuments%5Cprojects%5Cremix_-digicred-v9&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
